...
use App\Http\Requests\City\AddRequest;
use App\Models\City;
...
class CityController extends Controller
{
    ...
    {
      $results = City::with(['createdBy', 'updatedBy'])->get();
      // dd($dishes->toArray());
    ...
    public function store(AddRequest $request)
    {
      ...
      try {
        City::createWithTransaction($validated);
    ...
    public function update(AddRequest $request, string $id)
    {
      ...
      try {
        City::updateWithTransaction($id, $validated);
