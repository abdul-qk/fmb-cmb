      ...
      <div class="bg-transparent border-0 card shadow-none pt-2">
        <div class="row">
          ...
          <div class="col-md-4 col-lg-3 mb-5">
            ...
            <input disabled type="text" class="form-control" name="floor" id="floor" value="{{old('floor',$result->floor)}}">
          ...
          <div class="col-md-4 col-lg-3 mb-5">
            ...
            <select class="form-select" disabled name="default" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
              <option value=""></option>
