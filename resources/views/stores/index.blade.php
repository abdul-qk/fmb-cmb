            ...
            <table id="kt_datatable" class="table table-bordered gy-5">
              ...
              <tbody>
                ...
                <tr class="text-capitalize">
                  <td>{{ (isset($result->place->country->code) ? $result->place->country->code : "") .''.  (isset($result->place->location->city->name) ? (isset($result->place->location->country->code) ? ' - ' :'') . $result->place->location->city->name : '') . ' ' . (isset($result->place->location->area) ? (isset($result->place->location->city->name) ? ' - ' :'') . $result->place->location->area : "") }}</td>
                  <td>{{$result->place["name"]}}</td>
                  <!-- <td> {{$result->floor == 0 ? 'Ground' : 'Level '. $result->floor }}</td> -->
                  <td> {{$result->floor }}</td>
                  <td class="text-capitalize"> {{$result->default }}</td>
                  <td>
