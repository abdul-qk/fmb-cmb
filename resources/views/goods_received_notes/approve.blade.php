                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        ...
                        <tr id="item-row-{{ $index }}">
                            ...
                            <td>
                                <input type="number" class="form-control disable w-150px w-lg-100" value="{{ $item->quantity }}">
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="number" step="0.01" name="items[{{ $index }}][unit_price]" class="form-control w-150px w-lg-100 unit-price-input disable" value="{{ $item->unit_price }}">
                            </td>
                            <td>
