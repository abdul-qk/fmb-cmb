        ...
        <form class="form" method="POST" action="{{ route($store) }}">
          ...
          <div class="col-md-4 col-lg-3 mb-5">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="short_form" id="short_form" value="{{old('short_form')}}">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <select class="form-select" required name="default" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                <option value=""></option>
                <option value="yes" {{ old('default', 'no') == "yes" ? 'selected' : '' }}>Yes</option>
                <option value="no" {{ old('default', 'no') == "no" ? 'selected' : '' }}>No</option>
              </select>
