          ...
          <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
              ...
              <a type="button" class="btn btn-primary" href="{{ route($create) }}">
                <i class="ki-outline ki-plus fs-2"></i>Generate PO</a>
              @endif
              <!--end::Add button-->
            </div>
            <!--end::Toolbar-->
            ...
            <table id="kt_datatable" class="table table-bordered gy-5">
              ...
              <tbody>
                ...
                <td> {{$result->id}} </td>
                  ...
                  <td> {{number_format($result->amount)}} {{$result->currency->short_form}}</td>
                  <td class="text-capitalize">
                    ...
                    <span class="doc-file position-relative">
                      <a title="PO Document" class="d-inline-flex align-items-end" style="display: inline-block;" href="{{ url($result->pdfUrl) }}" target="_blank">
                        <i class="bi bi-file-earmark-text text-primary fs-2x"></i>
                      </a>
                    </span>
                    @endif
                    @if ($result->approvedPdfUrl != '')
                    
                    <span class="doc-file position-relative">
                      <a title="PO Document Approved" class="d-inline-flex align-items-end" style="display: inline-block;" href="{{ url($result->approvedPdfUrl) }}" target="_blank">
                  ...
                  <td>
                    ...
                    <form id="reject-form-{{ $result->id }}" action="{{ route('purchase_orders.reject', $result->id) }}" method="POST" style="display: none;">
                      @csrf
                      @method('PUT')
                    </form>
                    <!-- Delete Button -->
                    ...
                    <br />
                    <a title="Approve" href="{{ route('purchase_orders.approve', $result->id) }}" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm mt-3 me-3">
