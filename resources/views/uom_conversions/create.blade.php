          ...
          <div class="row">
           <div class="col-md-4 col-lg-3 mb-5">
              ...
              <select class="form-select" id="base_uom" name="base_uom" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                ...
                <option value="{{ $unitMeasure->id }}" {{ old('base_uom') == $unitMeasure->id ? 'selected' : '' }}>{{ $unitMeasure->name }}</option>
                @endforeach
              </select>
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="conversion_value" id="conversion_value" value="{{old('conversion_value')}}">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <select class="form-select" id="secondary_uom" name="secondary_uom" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                <option value=""></option>
                @foreach($unitMeasures as $unitMeasure)
                <option value="{{ $unitMeasure->id }}" {{ old('secondary_uom') == $unitMeasure->id ? 'selected' : '' }}>{{ $unitMeasure->name }}</option>
                @endforeach
              </select>
            ...
            <div class="col-md-12 mt-3">
              ...
              <input type="submit" id="create-btn" value="Create" class="btn btn-primary hover-elevate-up w-100px">
            </div>
          </div>
        </form>
      </div>
