    ...
    <!--begin::Container-->
     <div class="container-fluid" id="kt_content_container">
      ...
      <div class="bg-transparent border-0 card shadow-none pt-2">
        <form id="recipe-from" class="form" method="POST" action="{{ route($store) }}">
          @csrf
          <div class="row">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <select class="form-select" id="serving" name="serving_item" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                <option value=""></option>
                <option value="tiffin" {{ old('serving_item') == 'tiffin' ? 'selected' : '' }}>Tiffin</option>
                <option value="thaal" {{ old('serving_item') == 'thaal' ? 'selected' : '' }}>Thaal</option>
                <option value="thaal-tiffin" {{ old('serving_item') == 'thaal-tiffin' ? 'selected' : '' }}>Thaal + Tiffin</option>
              </select>
            ...
            <div class="col-md-12">
              ...
              <input type="button" value="Create" class="btn submit-button btn-primary hover-elevate-up w-100px">
            </div>
          </div>
        </form>
      </div>
