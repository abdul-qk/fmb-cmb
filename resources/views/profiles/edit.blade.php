    ...
    <!--begin::Container-->
     <div class="container-fluid" id="kt_content_container">
      ...
      <div class="bg-transparent border-0 card shadow-none pt-2">
        <form class="form" method="POST" action="{{ route($update, $result->id) }}" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="row">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input hidden type="number" class="form-control" name="user_id" value="{{ $result->user_id }}">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="complete_address" id="complete_address" value="{{ old('complete_address',$result->complete_address) }}">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="national_identity" id="national_identity" value="{{ old('national_identity',$result->national_identity) }}" minlength="8" maxlength="15">
            ...
            @if(!empty($filteredFilesIdentities))
            <div class="col-md-4 col-lg-3 mb-5">
              <label class="form-label">National Identity Documents</label>
              <div class="flex-wrap mb-5 d-flex align-items-end" style="gap: 10px; height: 40px;">
                @foreach($filteredFilesIdentities as $file)
                <span class="doc-file position-relative">
                  <i onclick="deleteDoc('upload_national_identity', '{{ $result->user_id.'=' . $file }}')" title="Delete" style="background: white;filter: drop-shadow(2px 4px 6px #00000078);padding: 2px;top: -5px;right: -3px;border-radius: 50px;font-size: 11px;" class="cursor-pointer text-danger bi bi-trash position-absolute"></i>
                  <a title="{{ $file }}" class="d-inline-flex align-items-end" style="display: inline-block;" href="{{ url('fetch-national-identity/'.$result->user_id.'=' . $file) }}" target="_blank">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <div id="contact-details-email">
                @foreach (old('emails',$result->emails->toArray() ?? []) as $index => $email)
                <div class="row mt-4" id="email-{{ $index }}">
                  <div class="col-md-12 mb-5">
                    <div class='d-flex justify-content-between align-items-center'>
                      <label class="form-label required"><span> Email Address {{$index + 1}}</span> </label>
            ...
            <div class="col-md-6">
              @foreach(old('contacts', $result->contacts->toArray() ?? [['contact_types' => '', 'contact_numbers' => '']]) as $index => $contact)
              <div class="row" id="contact-{{ $index }}">
                <div class="col-6 mb-5">
                  ...
                  <select required class="form-select" name="contacts[{{ $index }}][contact_types]" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                    <option value=""></option>
                    <option value="mobile" {{ old("contacts.$index.contact_types", $contact['contact_type'] ?? '') == 'mobile' ? 'selected' : '' }}>Mobile</option>
                    <option value="home" {{ old("contacts.$index.contact_types", $contact['contact_type'] ?? '') == 'home' ? 'selected' : '' }}>Home</option>
                  </select>
                ...
                <div class="col-6 mb-5">
                  ...
                  <input required type="text" class="form-control" name="contacts[{{ $index }}][contact_numbers]" placeholder="Contact Number" value="{{ old("contacts.$index.contact_numbers", $contact['contact_number'] ?? '') }}">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <select class="form-select" name="working_designation" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                ...
                <option></option>
                <option value="{{ $designation->id }}" {{ old('working_designation',$result->working_designation) == $designation->id ? 'selected' : '' }}>{{ $designation->name }}</option>
                @endforeach
              </select>
            ...
            <div class="col-md-3 mb-3">
              ...
              <textarea class="form-control" name="responsibilities" id="responsibilities">{{ old('responsibilities',$result->responsibilities) }}</textarea>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <select class="form-select" name="education_id" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                ...
                <option></option>
                <option value="{{ $education->id }}" {{ old('education_id',$result->education_id) == $education->id ? 'selected' : '' }}>
                  {{ $education->name }}
                </option>
                @endforeach
              </select>
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <select class="form-select" name="status" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                <option value=""></option>
                <option value="completed" {{ old('status',$result->status) == 'completed' ? 'selected' : '' }}>Completed</option>
                <option value="in_progress" {{ old('status',$result->status) == 'in_progress' ? 'selected' : '' }}>In Progress</option>
                <option value="just_started" {{ old('status',$result->status) == 'just_started' ? 'selected' : '' }}>Just Started</option>
                <option value="about_to_start" {{ old('status',$result->status) == 'about_to_start' ? 'selected' : '' }}>About to Start</option>
              </select>
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input value="{{ old('start_year',$result->start_year) }}" type="number" class="form-control" name="start_year" placeholder="Start Year" min="1900" max="2099" step="1">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input value="{{ old('end_year',$result->end_year) }}" type="number" class="form-control" name="end_year" placeholder="End Year" min="1900" max="2099" step="1">
          ...
          <div class="row" id="past-experience">
            ...
            @foreach(old('experiences', $result->experiences->toArray() ?? [['company' => '', 'years' => '', 'designation' => '']]) as $index => $experience)
            <div class="row mb-4" id="experience-{{ $index }}">
              <div class="col-md-4 col-lg-3 mb-5">
                <label class="form-label">Company/Organization {{$index == 0 ? "" : $index}}</label>
                <input required type="text" class="form-control" name="experiences[{{ $index }}][company]" placeholder="Company/Organization" value="{{ old("experiences.$index.company", $experience['company'] ?? '') }}">
              ...
              <div class="col-md-4 col-lg-3 mb-5">
                ...
                <input required type="number" min="0" class="form-control" name="experiences[{{ $index }}][years]" placeholder="No. of Years" value="{{ old("experiences.$index.years", $experience['years'] ?? '') }}">
              ...
              <div class="col-md-4 col-lg-3 mb-5">
                ...
                <select required class="form-select" name="experiences[{{ $index }}][designation]" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                  <option></option>
                  @foreach($designations as $designation)
                  <option value="{{ $designation->id }}" {{ old("experiences.$index.designation", $experience['designation_id'] ?? '') == $designation->id ? 'selected' : '' }}>{{ $designation->name }}</option>
                  @endforeach
                </select>
          ...
          <div class="row">
            ...
            @if(!empty($filteredFilesMisc))
            <div class="col-md-4 col-lg-3 mb-5">
              <label class="form-label"> Misc Documents</label>
              <div class="flex-wrap mb-5 d-flex align-items-end" style="gap: 10px;height:40px;">
                @foreach($filteredFilesMisc as $file)
                <span class="doc-file position-relative">
                  <i onclick="deleteDoc('misc_documents', '{{ $result->user_id.'=' . $file }}')" title="Delete" style="background: white;filter: drop-shadow(2px 4px 6px #00000078);padding: 2px;top: -5px;right: -3px;border-radius: 50px;font-size: 11px;" class="cursor-pointer text-danger bi bi-trash position-absolute"></i>
                  <a title="{{$file}}" class="d-inline-flex align-items-end" style="display:inline-block" href="{{ url('fetch-misc-documents/'.$result->user_id.'=' . $file) }}" target="_blank">
                    <i class="bi bi-file-earmark-text text-primary fs-2x"></i>
                  </a>
                </span>
                @endforeach
          ...
          <div class="row mt-4">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" value="{{ old('disease',$result->disease) }}" name="disease" placeholder="Disease">
            </div>
            <div class="col-md-4 col-lg-3 mb-5 ">
              <label class="form-label">Treatment</label>
              <input type="text" class="form-control" name="treatment" value="{{ old('treatment',$result->treatment) }}" placeholder="Treatment">
            </div>
            <div class="col-md-4 col-lg-3 mb-5">
              <label class="form-label">No. of Years</label>
              <input type="number" min="1" class="form-control" name="no_of_years" value="{{ old('no_of_years',$result->no_of_years) }}" placeholder="No. of Years">
            </div>
            <div class="col-md-4 col-lg-3 mb-5">
            ...
            @if(!empty($filteredFilesMedical))
            <div class="col-md-4 col-lg-3 mb-5">
              <label class="form-label"> Medical Documents</label>
              <div class="flex-wrap mb-5 d-flex align-items-end" style="gap: 10px;height:40px;">
                @foreach($filteredFilesMedical as $file)
                <span class="doc-file position-relative">
                  <i onclick="deleteDoc('medical_documents', '{{ $result->user_id.'=' . $file }}')" title="Delete" style="background: white;filter: drop-shadow(2px 4px 6px #00000078);padding: 2px;top: -5px;right: -3px;border-radius: 50px;font-size: 11px;" class="cursor-pointer text-danger bi bi-trash position-absolute"></i>
                  <a title="{{$file}}" class="d-inline-flex align-items-end" style="display:inline-block" href="{{ url('fetch-medical-documents/'.$result->user_id.'=' . $file) }}" target="_blank">
                    <i class="bi bi-file-earmark-text text-primary fs-2x"></i>
                  </a>
                </span>
                @endforeach
...
<script>
  $('#country_id').change(function() {
    ...
    let cities_id = "{{old('city_id',$result->city_id)}}";
  ...
  let emailCount = "{{ count(old('emails',$result->emails->toArray() ?? [] [['contact_types' => '', 'contact_numbers' => '']])) }}"; // Initialize a counter for emails
  let contactCount = "{{ count(old('contacts', $result->contacts->toArray() ?? [['contact_types' => '', 'contact_numbers' => '']])) }}";
  let experienceCount = "{{ count(old('experiences', $result->experiences->toArray() ?? [['company' => '', 'years' => '', 'designation' => '']])) }}";
