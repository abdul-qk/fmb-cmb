      ...
      <div class="bg-transparent border-0 card shadow-none pt-2">
        <div class="row">
          <div class="col-md-4 col-lg-3 mb-5">
            ...
            <select disabled class="form-select " name="country_id" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
              <option value=""></option>
          ...
          <div class="col-md-4 col-lg-3 mb-5">
            ...
            <select disabled class="form-select " name="in_european_union" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
              <option value=""></option>
              <option value="yes" {{ old('in_european_union',$result->in_european_union) == "yes" ? 'selected' : '' }}>Yes</option>
              <option value="no" {{ old('in_european_union',$result->in_european_union) == "no" ? 'selected' : '' }}>No</option>
            </select>
