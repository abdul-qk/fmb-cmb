        ...
        <div class="row">
          ...
          <div class="col-md-3 col-lg-3 mb-5">
            ...
            <div class="col-md-3 col-lg-3 mb-5">
              ...
              <select disabled class="form-select" name="currency_id" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                <option value=""></option>
                @foreach($currencies as $currency)
                  <option value="{{ $currency->id }}" {{ old('currency_id',$result->currency->id) == $currency->id ? 'selected' : '' }}>{{ $currency->short_form }}</option>
                @endforeach
              </select>
