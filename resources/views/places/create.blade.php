        ...
        <form class="form" method="POST" action="{{ route($store) }}">
          ...
          <div class="row">
            <div class="col-md-3 col-lg-3 mb-5">
              ...
              <select class="form-select " id="location_id" name="location_id" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                <option value=""></option>
                @foreach($locations as $location)
                <option value="{{ $location->id }}" {{ old('location_id') == $location->id ? 'selected' : '' }}>{{ $location->country->code .' - '. $location->city->name .' - '. $location->area }}</option>
                @endforeach
              </select>
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="contact_no" id="contact_no" value="{{old('contact_no')}}">
