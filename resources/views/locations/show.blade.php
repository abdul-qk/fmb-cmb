    ...
    <div class="container-fluid" id="kt_content_container">
      ...
      <div class="bg-transparent border-0 card shadow-none pt-2">
        ...
        <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input disabled type="text" class="form-control" name="country" id="country" value="{{old('country',$result->country)}}">
            </div>
            <div class="col-md-4 col-lg-3 mb-5">
              <label class="form-label required">City</label>
              <input disabled type="text" class="form-control" name="city" id="city" value="{{old('city',$result->city)}}">
            </div>
            <div class="col-md-4 col-lg-3 mb-5">
              <label class="form-label required">Area</label>
              <input disabled type="text" class="form-control" name="area" id="area" value="{{old('area',$result->area)}}">
            </div>
        </div>
      </div>
      <!--end::Card-->
