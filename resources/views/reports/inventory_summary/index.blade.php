                                    ...
                                    <tbody>
                                        @foreach ($results as $result)
                                            <tr>
                                                ...
                                                <td>{{ $result['initial_quantity'] }}</td>
                                                <td>{{ $result['requested_quantity'] }}</td>
                                                <td>{{ $result['issued_quantity'] }}</td>
                                                <td>{{ ($result['inventory_quantity'] - $result['issued_quantity'] - $result['supplier_returned_quantity']) + $result['returned_quantity'] }}</td>
                                                <td>{{ $result['returned_quantity'] }}</td>
                                                <td>{{ $result['supplier_returned_quantity'] }}</td>
            ...
            var table = $("#kt_datatable").DataTable({
                ...
                "buttons": [{
                        ...
                        filename: function() {
                            ...
                            return `FMB_Inventory_Summary_Report_${dateFrom}_${dateTo}`;
                        }
                    },
                    {
                        extend: 'pdfHtml5',
