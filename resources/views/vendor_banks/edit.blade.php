        ...
        <form class="form" method="POST" action="{{ route($update, $result->id) }}">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="bank_title" id="bank_title" value="{{old('bank_title',$result->bank_title)}}">
            ...
            <div class="col-md-3 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="account_no" id="account_no" value="{{old('account_no',$result->account_no)}}">
            ...
            <div class="col-md-3 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="bank" id="bank" value="{{old('bank',$result->bank)}}">
              @if ($errors->has('bank'))
            ...
            <div class="col-md-3 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="bank_branch" id="bank_branch" value="{{old('bank_branch',$result->bank_branch)}}">
            ...
            <div class="col-md-3 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="ntn" id="ntn" value="{{old('ntn',$result->ntn)}}">
              @if ($errors->has('ntn'))
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <textarea type="text" class="form-control" name="bank_address" id="bank_address">{{old('bank_address',$result->bank_address)}}</textarea>
