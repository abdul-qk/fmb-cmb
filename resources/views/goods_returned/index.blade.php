          ...
          <div class="card-toolbar">
              ...
              <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                  ...
                  @if(hasPermissionForModule('add', $currentModuleId))
                      <a type="button" class="btn btn-primary" href="/issued-to-kitchens/create">
                      <i class="ki-outline ki-plus fs-2"></i>Return from Kitchen</a>
                  @endif
                  <!--end::Add button-->
              </div>
              <!--end::Toolbar-->
            ...
            <table id="kt_datatable" class="table table-bordered gy-5">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>{{( $result->kitchen->floor_name )}}</td>
                    <td>
                        {{( $result->returnBy->name )}}
                    </td>
                    <td>
      ...
      "buttons": [
        {
          ...
          return `FMB_Returned_From_Kitchen_${dateTime}`;
          },
          exportOptions: {
