                ...
                <tbody id="items-table-body">
                  ...
                  <tr id="item-row-{{ $index }}">
                      ...
                      <td>
                          ...
                          <input type="hidden" class="form-control hidden-base-uom w-150px w-lg-100" name="items[{{ $index }}][base_unit_id]" value="{{$item['base_unit_id']}}">
                      </td>
                      <td>
...
<script>
    $(document).ready(function() {
        ...
        if (!anyError) {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ route('fetchAdjustmentItems') }}",
        ...
        function addItemRow(items, units,itemValues) {
            ...
            let availableQuantity = $('#items-table-body .available-quantity').length;
            ...
            $('#items-table-body').append(`
                <tr id="item-row-${itemIndex}">
                    ...
                    <td>
                        ...
                        <input type="hidden" class="form-control hidden-base-uom w-150px w-lg-100" name="items[${itemIndex}][base_unit_id]">
                    </td>
                    <td>
        ...
        function populateItemDetails(loader, itemId) {
          ...
          let hiddenBaseUom = $(loader).closest("tr").find(".hidden-base-uom");
          ...
          $.get("/fetch-item-details", data, function(response) {
            ...
            $(hiddenBaseUom).val(response?.item_base?.base_uom?.id);
