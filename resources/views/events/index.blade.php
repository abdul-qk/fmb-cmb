            ...
            <table id="kt_datatable" class="table table-bordered gy-5">
              <thead>
                <tr class="fw-semibold fs-6 text-muted">
                  ...
                  <th style="vertical-align: middle;">Serving Pax</th>
              ...
              <tbody>
                ...
                <tr class="text-capitalize">
                  ...
                  <td>{{$result["event"]["serving_persons"]}}</td>
                  ...
                  <td>
                   @if(hasPermissionForModule('show', $currentModuleId))
                      ...
                      <a title="Reject" href="#" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm mb-3 me-3" onclick="event.preventDefault(); confirmReject({{ $result['event']['id'] }});">
                      ...
                      @if($result['menu'] == null) 
                      <a title="Create Menu" href="{{ route('events.create-menu', $result['event']['id']) }}" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm mb-3 me-3">
                      ...
                      <a title="Chef Input" href="{{ route('events.create-chef-menu', $result['event']['id']) }}" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3 mb-3">
                      ...
                      @if(isset($result['menu']['id']))
                        <a title="Menu Item List" href="{{ route('menu-items.show', $result['menu']['id']) }}" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3 mb-3">
                      ...
                      @if(isset($result['menu']['id']))
                        @if($result['menu'] != null && $result['menu']->item_quantity == 'chef-input') 
                          <a title="Edit Chef Input" href="{{ route('menus.edit-chef-input', $result['menu']->id) }}" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3 mb-3">
