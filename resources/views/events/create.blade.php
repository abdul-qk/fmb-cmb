        ...
        <form class="form" method="POST" action="{{ route($store) }}">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input class="form-control tiffin-field" type="time" id="start" name="start" value="{{old('start')}}">
              @if ($errors->has('start'))
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input class="form-control tiffin-field" type="time" id="end" name="end" value="{{old('end')}}">
              @if ($errors->has('end'))
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <select class="form-select " name="meal" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                <option value=""></option>
                <option value="breakfast" {{ old('meal') == 'breakfast' ? 'selected' : '' }}>Breakfast</option>
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <select class="form-select" id="serving" name="serving" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                ...
                <option value="thaal-tiffin" {{ old('serving') == 'thaal-tiffin' ? 'selected' : '' }}>Thaal + Tiffin</option>
              </select>
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="host_its_no" id="host_its_no" value="{{old('host_its_no')}}">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="host_sabeel_no" id="host_sabeel_no" value="{{old('host_sabeel_no')}}">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="host_name" id="host_name" value="{{old('host_name')}}">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <textarea class="form-control" name="host_menu" id="host_menu">{{old('host_menu')}}</textarea>
            ...
            <div id="thaalField" class="col-md-4 col-lg-3 mb-5" style="display:none;">
              ...
              <input type="number" class="form-control" min="0" id="no_of_thaal" name="no_of_thaal" value="{{ old('no_of_thaal') }}">
                ...
                <div class="col-md-4 col-lg-3 mb-5">
                  ...
                  <div class="d-flex border border-1 rounded-4">
                    <div class="bg-light p-3 d-flex justify-content-center align-items-center">
                      <input class="tiffan_type" type="checkbox" name="tiffan_type[{{$result->id}}]" value="{{ $result->id }}" id="result_{{ $result->id }}"
                        {{ in_array($result->id, old('tiffan_type', [])) ? 'checked' : '' }}>
                    </div>
                    <input type="number" min="0" value="{{ old('no_of_taffin.' . $result->id, 1) }}" name="no_of_taffin[{{ $result->id }}]" id="no_of_taffin_{{$result->id}}" placeholder="No. of Tiffin" class="form-control no_of_taffin" disabled />
                  </div>
                </div>
                @endforeach
              </div>
...
<script>
  $(document).ready(function() {
    ...
    if (anyError) {
      toggleFields(); // Call the toggleFields function
      $('.tiffan_type').each(function() {
