        ...
        <form class="form" method="POST" action="{{ route($update, $result->id) }}">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="code" id="code" value="{{old('code',$result->code)}}" />
              @if ($errors->has('code'))
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="state" id="state" value="{{old('state',$result->state)}}" />
              @if ($errors->has('state'))
