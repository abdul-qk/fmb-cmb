      ...
      <div class="bg-transparent border-0 card shadow-none pt-2">
        <div class="row">
          ...
          <div class="col-md-4 col-lg-3 mb-5">
            ...
            <input disabled type="text" class="form-control" name="code" id="code" value="{{old('code',$result->code)}}">
          </div>
          <div class="col-md-4 col-lg-3 mb-5">
            <label class="form-label required">State</label>
            <input disabled type="text" class="form-control" name="state" id="state" value="{{old('state',$result->state) ?? '-'}}">
          </div>
        </div>
      </div>
      <!--end::Card-->
