                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <a type="button" class="btn btn-primary me-2" href="/inventories/create">
                            ...
                            <a type="button" class="btn btn-primary" href="/goods-received-notes/create">
                        ...
                        <table id="kt_datatable" class="table table-bordered gy-5">
                            ...
                            <tbody>
                                @foreach($results as $key => $result)
                                    @php
                                    $placeName = optional(optional($result->kitchen)->place)->name ?? '-';
                                    $floor = optional($result->kitchen)->floor;
                                    @endphp
                                    <tr>
                                        <td>{{( $result->id )}}</td>
                                        ...
                                        <td>{{( $result->created_at->isoFormat('Do MMM YYYY') )}}</td>
                                        <td>{{( $result->inventoryDetail->receivedBy->name )}}</td>
                                        <td>
                                        <!-- <a title="Return Goods" href="{{ route($edit, $result->id) }}" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3">
            ...
            "buttons": [
                {
                    ...
                    return `FMB_Issued_To_Kitchen_${dateTime}`;
                    },
                    exportOptions: {
