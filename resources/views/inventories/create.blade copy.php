                  ...
                  <table class="table table-bordered table-2">
                    <thead>
                      <tr>
                        ...
                        <th>Issue UOM</th>
                        <th>Issue Qty</th>
                        <th title="Add More" style="width:45px" class="text-center">
                    ...
                    <tbody id="issue-table-body">
                      ...
                      <tr id="item-row-{{ $index }}">
                        ...
                        <td>
                          ...
                          @if($index != 0)
                          <svg title="Remove" class="remove-item-btn cursor-pointer" data-row-id="item-row-{{ $index }}" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="25" x="0" y="0" viewBox="0 0 384 384" style="enable-background:new 0 0 512 512" xml:space="preserve">
                            <g>
              ...
              response.forEach(item => {
                $('#items-table-body').append(`
                    <tr>
                        ...
                        <td>
                          <input type="number" step="0.001" class="form-control w-150px w-lg-100 quantity-input" name="quantity[${item.id}]" value="${item.remaining_quantity}">
