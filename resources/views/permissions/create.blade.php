                ...
                <form class="form" method="POST" action="{{ route($store) }}">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-3 mb-5">
                            ...
                            <select class="form-select form-select-solid email-block" name="module_id" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                                <option value=""></option>
                        ...
                        <div class="col-md-4 col-lg-3 mb-5">
                            ...
                            <input type="text" class="form-control" name="name" id="name" value="{{old('name')}}" placeholder="should be like: export-data">
                            @if ($errors->has('name'))
