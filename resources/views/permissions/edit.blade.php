        ...
        <!--begin::Container-->
         <div class="container-fluid" id="kt_content_container">
            ...
            <div class="bg-transparent border-0 card shadow-none pt-2">
                <form class="form" method="POST" action="{{ route($update, $permission->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <input type="hidden" class="form-control" name="module_id" id="module_id" value="{{$permission->module->id}}">
                        <div class="col-md-4 col-lg-3 mb-5">
                            <label class="form-label">Module</label>
                            <input type="text" class="form-control" name="module" id="module" value="{{$permission->module->name}}" disabled>
                        </div>
                        <div class="col-md-4 col-lg-3 mb-5">
