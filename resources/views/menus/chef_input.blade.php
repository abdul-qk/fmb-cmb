  ...
  <div id="kt_post">
    ...
    <div class="container-fluid" id="kt_content_container">
      ...
      <div class="bg-transparent border-0 card shadow-none pt-2">
        ...
        <form class="form" id="chef-input-from" method="POST" action="{{ route('menus.chef-input.store', $result->id) }}">
          @csrf
          ...
          <div class="main-row" id="dish-${selectedId}">
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr class="">
                    <td class="">
                      <select required class="form-select item" name="items[{{$recipe->id}}][0][ingredient_id]" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                        <option value=""></option>
                    ...
                    <td class="">
                      <input required type="number" step="0.001" class="form-control" name="items[{{$recipe->id}}][0][item_quantity]" id="item_quantity" value="">
                    ...
                    <td class="">
                      <div class="position-relative">
                        ...
                        <select required class="form-select unit_measure" name="items[{{$recipe->id}}][0][unit_measure]" data-control="select2" data-close-on-select="false" data-placeholder="Select" data-allow-clear="true">
                          <option value=""></option>
                        </select>
                      </div>
                    ...
                    <td class="text-center" style="vertical-align:middle">
                      ...
                      <textarea class="form-control d-none" name="items[{{$recipe->id}}][0][description]"></textarea>
