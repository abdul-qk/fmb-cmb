        ...
        <form class="form" method="POST" action="{{ route($store) }}">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="contact_number" id="contact_number" value="{{old('contact_number')}}" placeholder="With country code">
            ...
            <div class="col-md-3 col-lg-3 mb-5">
              ...
              <input type="text" class="form-control" name="office_number" id="office_number" value="{{old('office_number')}}" placeholder="With country code">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
              ...
              <textarea class="form-control" name="bank_address" id="bank_address">{{old('bank_address')}}</textarea>
            ...
            <div class="col-md-12 mb-5">
              ...
              <select class="form-select" id="items" name="items[]" multiple data-control="select2" data-close-on-select="false" data-placeholder="Select items" data-allow-clear="true">
                <option value=""></option>
